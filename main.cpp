...
void setup() {
	...
	//SPI.setMode(DSPI_MODE3); // Default: SPI_MODE3
	spiFlash.begin();
	Serial.print("JEDEC ID:");
	Serial.println(spiFlash.jedecIdRead());
	//digitalWrite(10, LOW);
	//delayMicroseconds(1);
	//SPI.transfer(0x9f);
	//uint8_t id[3] = {0,0,0};
	//SPI.transfer(3, id, id);
	//Serial.println(id[0]);
	//	Serial.println(id[1]);
	//		Serial.println(id[2]);
	//		digitalWrite(10, HIGH);
	//Serial.println(__PIC32_pbClk);
